...
final List<Facultad> mockFacultades = [
  Facultad(
    ...
    escuelas: [
      Escuela(id: 'e001', nombre: 'Ingenieria de Sistemas e Informatica', facultadId: 'f001'),
      Escuela(id: 'e002', nombre: 'Educacion y Comunicacion', facultadId: 'f001'),
      Escuela(id: 'e003', nombre: 'Estadistica e Informatica', facultadId: 'f001'),
    ],
  ),
  Facultad(
    id: 'f002',
...
final List<Profesor> mockProfesores = [
  Profesor(
    ...
    escuelaId: 'e001',
    calificacion: 4.5,
    fotoUrl: 'https://media-lim1-1.cdn.whatsapp.net/v/t61.24694-24/293874895_451436070133149_3343926150248203909_n.jpg?ccb=11-4&oh=01_Q5Aa3gGbjY4x6qBoTkh09Q4R-AS1Hx5OiCySRQJ9NL2e_tP9_w&oe=697A709E&_nc_sid=5e03e0&_nc_cat=100',
  ...
  Profesor(
    ...
    escuelaId: 'e001',
    calificacion: 4.9,
    fotoUrl: 'https://media-lim1-1.cdn.whatsapp.net/v/t61.24694-24/414728706_1417097939225101_4291173992527253576_n.jpg?ccb=11-4&oh=01_Q5Aa3gHeNGirJtdElJqclgny8qTKjHOcVEyxgqaAEjsq44qv-g&oe=697A64E6&_nc_sid=5e03e0&_nc_cat=105',
  ...
  Profesor(
    ...
    escuelaId: 'e004',
    calificacion: 4.7,
    fotoUrl: 'https://media-lim1-1.cdn.whatsapp.net/v/t61.24694-24/397590148_862542188869178_7427810096452653571_n.jpg?ccb=11-4&oh=01_Q5Aa3gFYSry02Dfudb9Hhxof8SvNjYO-f1oaKKevtx_mO6fXoA&oe=697A5E95&_nc_sid=5e03e0&_nc_cat=105',
